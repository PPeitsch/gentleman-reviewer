...
- **Consistencia**: Todos los miembros del equipo usan las mismas reglas (REVIEW_RULES.md)
- **Sin configuración personal**: No hay `EXTRA_INSTRUCTIONS` ni overrides por desarrollador
- **Una fuente de verdad**: El archivo REVIEW_RULES.md define todas las reglas

### REVIEW_RULES.md es THE place para instrucciones
...
Si necesitás reglas específicas por módulo, usá **referencias** en tu REVIEW_RULES.md:
...
├── bin/
│   └── gga                 # Script principal (~1200 líneas)
├── lib/
...
1. **Hash de reglas**: Si REVIEW_RULES.md o .gga cambian, se invalida todo el cache
